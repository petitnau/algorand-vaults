...
The following code is generated by the AlgoML compiler.

The TEAL code for the escrow account gives all of its "decisional power" to the stateful contract, which will control the escrow spendings.
